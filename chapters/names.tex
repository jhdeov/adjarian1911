...
\armenian{Մանիշակ}&\armenian{Մենեշմե} & Manishag?\footnote{I couldn't track down a pre-existing romanization.}& &\ref{page:184}\\ \hline
...
\armenian{Քոռուն}&\armenian{Քորուն} & Korun?\footnote{I couldn't track down a pre-existing romanization.}& &\ref{page:138}\\ \hline
