...
In 1866, the grammar of the Viennese monk Arsen Aydinian (\armenian{Հ. Ա. Այտընեան}; \translatorHD{SWA: /ɑɾsen ɑjdinjɑn/}) was published \citep{Aydinian-1866-CriticalGrammarArmenian}, wherein the author gave the first general classification of the Armenian dialects, though in very uncertain terms. Aydinian recognized four dialectal branches. 
...
\begin{table}[H]
	...
	\begin{tabular}{ lll|lll|lll }
		\lsptoprule \multicolumn{3}{ l|}{Armenian letter} & \multicolumn{3}{l|}{Adjarian's transcription} & \multicolumn{3}{ |}{IPA letter} 
		\\ \midrule 
...
The only sound that we must inevitable mold is the small <\armenian{յ}> symbol. This has a wide use. It will be used to form the diphthongs /ɑi̯, ei̯, ii̯, oi̯/ <\armenian{այ, էյ, իյ, օյ}>, and to form the palatal sounds /ɡʲ, kʲ, kʰʲ, ç/ <\armenian{գյ, կյ, քյ, հյ}>.\footnote{\translatorHD{Adjarian implies that he wants this symbol <\armenian{յ}> to be a subscript. But the printed editions don't show a subscript form. It's possible that reprints of his work couldn't do a subscript <\armenian{յ}>. I don't do any subscript notation because I ultimately don't know what exact sounds he wants. See \S\ref{sec:HossepIntro:phonotransc:adj:typograph}. For a   discussion on the phonetic value of these consonants, see \S\ref{sec:HossepInro:phonotransc:adj:implicit:palatal}.}}
...
\begin{table}[H]
	...
	\begin{tabular}{ lll|ll }
		\lsptoprule & &Trad. Ortho. & \multicolumn{2}{l|}{Transcription (SWA)} \\ \midrule
...
\begin{table}[H]
	...
	\begin{tabular}{ ll|l l|l l }
		...
		\armenian{ուա}&u̯ɑ &vɑ & \armenian{վա}&vɑ & \armenian{վա} \\\lspbottomrule
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{  l | ll ll  }
		\lsptoprule & `to waste' & & `wedding' & \\ \midrule
...
\begin{table}[H]
	...
	\begin{tabular}{  l | ll | ll | ll }
		\lsptoprule &Classical & & > SWA && Other & \\
	\midrule	`to pass' & ɑnt͡sʰɑnel & \armenian{անցանել} & ɑnt͡sʰnil & \armenian{անցնիլ} & ɑsnil & \armenian{ասնիլ}
		\\
		`to recognize' & t͡ʃɑnɑt͡ʃʰel & \armenian{ճանաչել} &d͡ʒɑnt͡ʃʰnɑl & \armenian{ճանչնալ} & t͡ʃɑʃnɑl & \armenian{ճաշնալ}
		\\
		`to button' & *kot͡ʃɑkel & *\armenian{կոճակել} &ɡod͡ʒɡel & \armenian{կոճկել} & koʒkel & \armenian{կոժկէլ} \\ \lspbottomrule
	\end{tabular}
}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{ l|ll|lll }
		\lsptoprule &Classical& &> Modern & & \\
	\midrule	\hline `bridge' & kɑmuɾd͡ʒ & \armenian{կամուրջ} & kɑɾmund͡ʒ & \armenian{կարմունջ} & unspecified dialect 
		\\
...
\begin{table}[H]
	...
	\begin{tabular}{ l|ll|ll }
		\lsptoprule &\multicolumn{2}{l|}{Classical Armenian}& \multicolumn{2}{l|}{> Unspecified modern variety} \\ \midrule
...
{%	\resizebox{\textwidth}{!}{%
	\begin{tabular}{ l|ll|ll }
	\lsptoprule &\multicolumn{2}{l|}{Classical Armenian}& \multicolumn{2}{l|}{> SWA} \\ \midrule
