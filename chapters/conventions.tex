...
\begin{itemize}
	...
	\item <\armenian{օօ}> /oo/,  see \S\ref{section:shamakhi:phono:change:o:lengthening}. \item <հյ> /hʲ/ might be a voiceless palatal fricative /ç/.
\end{itemize}
...
However, in my own fieldwork, the dialect of Tehrani Iranian Armenian has a rounded back vowel /ɒ/ due to Persian contact \citep{DolatianEtAl-prep-IranianGrammar}. Perceiving this rounding is quite subtle. So it is possible that some of the dialects from Iran that Adjarian studied     did in fact use a back rounded form /ɒ/ instead of a back unrounded form /ɑ/. It is impossible to know what was the case 100 years ago.
...
I generally tried to morphologically segments as many words in possible. An exception is pronouns. I try to minimize my segmentation of pronouns because pronouns tend to contain a lot of opaque morphology. See \S\ref{section:julfa:morpho:pronoun}. 
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%  
		\begin{tabular}{llll}
			\hline 
			Paradigm name & Example &Literary reading & Spoken reading  \\
			\hline 
