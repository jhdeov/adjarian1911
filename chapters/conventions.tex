...
\begin{itemize}
	\item Minor comments on SEA and SWA consonant inventory\label{list:HossepIntro:seaConsList}
	\begin{enumerate}
...
\begin{itemize}
	\item Armenian symbols that I could not replicate easily\label{list:HossepIntro:transc:hardtypographical}
	\begin{enumerate}
...
\item Some diphthongs were written with a superscript form of the letter <\armenian{ի}>: <\armenian{ու}\textsuperscript{\armenian{յ}}, \armenian{ը}\textsuperscript{\armenian{յ}}>. I used a superscript <i>: 	<\armenian{ուⁱ}, \armenian{ըⁱ}>. 
...
\begin{itemize}
	\item Languages that Adjarian used \label{list:HossepIntro:adjarianLang}
	\begin{itemize}
		 \item French
\item Italian
\item German
