...
\begin{enumerate}
	...
	\item Dialect of Van (\S\ref{chapter:Mush})
...
\begin{table}[H]
	...
	\begin{tabular}{|ll| ll|ll| ll|}
		...
		& `boiling (CA); tingling (SEA)' & er-kʰ (-{\pl}) & \armenian{եռք} & jerkʰ & \armenian{յէռք} & jer-kʰ & \armenian{եռք} \\
...
\begin{table}[H]
	...
	\begin{tabular}{| l| ll|ll| ll|}
		...
		`to take pity on' & oɬoɾmil & \armenian{ողորմիլ} & oʁoɾmil & \armenian{օղօրմիլ} & voʁoɾmel & \armenian{ողորմել} \\
...
\begin{table}[H]
	...
	\begin{tabular}{|l| ll|ll| ll|}
		...
		`fountain' & ɑɬbiu̯ɾ & \armenian{աղբիւր} & ɦɑχbuɾ & \armenian{յ̵ախբուր} & ɑχpjuɾ & \armenian{աղբյուր} \\ 
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|}
		...
		`to take pity on' & oɬoɾmil & \armenian{ողորմիլ} & oʁoɾmi̯el & \armenian{օղօրմել} & voʁoɾmel & \armenian{ողորմել} \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|}
		...
		`frog' &ɡoɾt & \armenian{գորտ} & kʲœə̯rt & \armenian{կյէ\`օռտ} & ɡoɾt& \armenian{գորտ} \\
				`to assemble' &ʒoɬovel & \armenian{ժողովել} & ʒoʁvi̯el & \armenian{ժօղվել} & ʒoʁovel, & \armenian{ժողովել, } \\
...
\begin{table}[H]
	...
	\begin{tabular}{|ll|ll|ll|ll|}
		...
		& `branch' & t͡ʃiu̯ɬ & \armenian{ճիւղ}& t͡ʃoʁ & \armenian{ճօղ} & t͡ʃjuʁ & \armenian{ճյուղ} \\
		& `village' & ɡiu̯ɬ & \armenian{գիւղ}& kʲi̯eʁ & \armenian{կյեղ} & ɡjuʁ & \armenian{գյուղ} \\
		& `brick' & ɑɬiu̯s & \armenian{աղիւս}& oʁis & \armenian{օղիս} & ɑʁjus & \armenian{աղյուս} \\
		\hline
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|}
		...
		`(male?) child' & təɬɑ{j}-\'i & \armenian{տղայի} & təʁ\'ə & \armenian{տըղը՛} & təʁɑj-\'i & \armenian{տղայի} \\ 
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll|ll|}
		...
		`(male?) children' & təɬɑi̯-kʰ & \armenian{տղայք} & tʁejkʰ-dʰiɾ & \armenian{տղէյքդՙիր}& təʁɑ-kʰ & \armenian{տղաք} \\
		\hline
	\end{tabular}
...
Adjarian's source: This is narrated by the unfortuate this of Sopia (\armenian{Սոփիա}), Aslik (\armenian{Ասլիկ}). I transcribed it during my summer travels of 1907 in Basargechar. 
...
\begin{table}[H]
	...
	\begin{tabular}{|l| ll|ll| ll|}
		...
		`place' & teɬ & \armenian{տեղ}& dʰi̯eχ & \armenian{դՙեխ} & teʁ & \armenian{տեղ} \\ 	 
...
\begin{table}[H]
	...
	\begin{tabular}{|l| ll|ll| ll|}
		...
		`water-mill' &d͡ʒəɾɑɬɑt͡sʰ& \armenian{ջրաղաց} & t͡ʃʰæʁæɾt͡sʰ &\armenian{չա̈ղա̈րց} & d͡ʒəɾɑʁɑt͡sʰ& \armenian{ջրաղաց} \\ 
		\hline 
...
Adjarian's source: Ibid., 1898, \armenian{էջ} 538. The orthography is from \citeauthor{Byurakn}, such that the letter <\armenian{գ}> should be read as /ɡʰ/ <\armenian{գՙ}> , and /p-b/ <\armenian{պ-բ}> and so on. 
...
Adjarian's source: Taken from \citeauthor{Byurakn}, 1899, page 386.The orthography of the manuscript was preserved, even if inaccurate. 
...
\begin{table}[H]
	\centering
	\caption{Change from Classical Armenian /ɑ/ <\armenian{ա}> to /ɑ, æ, u, œ/ <\armenian{ա, ա̈}, \armenian{ու, էօ}> in the of the Cilicia dialect}
...
&       \multicolumn{2}{|| }{\armenian{Յիսուս Քրիստոս}} &      \multicolumn{2}{l|}{\armenian{Իւսիւս Քիւրիւսդիւս}} &  \multicolumn{2}{l}{\armenian{Հիսուս Քրիստոս} }&  \\ 
				\hline 
	\end{tabular}
\end{table}
...
It is clear that starting from the west regions of Cilicia until the borders of Smyrna and Nicomedia, there is no Armenian language. The local language, Turkish, has turned into the native language. But Armenian is still preserved in some villages. These are Stanoz (Yenikent) (western side of Ankara), Sivrihisar (south-west of it), Nallıhan (the north-west side of Stanoz), and a few villages next to Yozgat. Information is lacking on these places. For the language of Stanoz (Yenikent), there is some information and a small manuscript in \citeauthor{Byurakn} (1899, page 670; 1900, page 233). Although these pieces are not entirely sufficient for studying the language of these areas, but they appear to show that they as well form subdialects of Cilicia. 
...
By judging the aforementioned section from \citeauthor{HandesAmsorya}, which we will see later below, we can deduce that the Syrian dialect recognizes the vowels in Table \ref{tab:Syria:phono:segment:vowels}. 
...
\begin{table}[H]
	...
	\begin{tabular}{|l|ll|ll| lll|}
		...
		`soul-{\dist} (CA); soul-{\defgloss} (SEA)' & hoɡi-n & \armenian{հոգին} & hokʰĕi̯-n & \armenian{հօքէʲն} & hokʰi-n & \armenian{հոգին} & SEA \\
...
\begin{table}[H]
	...
	\begin{tabular}{|l| ll|ll| ll|}
		...
		`horse-radish' & boɬk & \armenian{բողկ} & bʰu̯œʁɡ & \armenian{բՙօ̂ղգ} & boχk & \armenian{բողկ} \\ 
...
\begin{table}[H]
	...
	\begin{tabular}{|ll| ll|ll| ll|}
		\hline& & \multicolumn{2}{l|}{Classical Armenian} &\multicolumn{2}{l|}{> Sebastia} & \multicolumn{2}{l|}{cf. SEA } \\ 
		a. & `hole (CA); pit (SEA)' &hoɾ & \armenian{հոր} & fu̯œɾ & \armenian{ֆօ̂ր} & hoɾ & \armenian{հոր} \\ 
		& `smell' & oɾtʰ & \armenian{որթ} & fu̯œɾtʰ &\armenian{ֆօ̂րթ} & hoɾt & \armenian{հորթ} \\
		&`earth' &hoɬ & \armenian{հող} & fu̯œʁ & \armenian{ֆօ̂ղ} & hoʁ & \armenian{հող} \\
...
\begin{table}[H]
	...
	\begin{tabular}{|l | ll|ll| ll|}
		...
		`horse-radish' & boɬk & \armenian{բողկ} & pʰu̯eʁɡ & \armenian{փուէղգ} & boχk & \armenian{բողկ} \\ 
...
For the subdialects in this region, the Aslanbeg subdialect has the most genuine and characteristic phenomena. And it is because of this that in Paris, I conducted a study on this subdialect, by working with a young person from Aslanbeg, Mr. Aleksan Nalbandian (\armenian{պր. Ալեքսան Նալբանդեան}). My study was published in \citeauthor{Bazmaveb}, and then published in a separate... 
...
\begin{table}[H]
	...
	\begin{tabular}{|l | ll|ll| lll|}
		...
		`to guide' & uɬe{we}ɾel & \armenian{ուղեւորել} & χɑvɾel & \armenian{խավրէլ} & uʁevoɾel & \armenian{ուղեւորել} & SEA\\
		...
		`name of& ɬɑt & \armenian{ղատ}  & χɑd & \armenian{խադ} &ʁɑt &  \armenian{ղատ} & SEA \\ 
		 letter <\armenian{ղ}>'  & & & & & & \\
		\hline 
	\end{tabular}
\end{table}
...
\begin{itemize}
	...
	\begin{itemize}
		\item \citet{Patkanian-1875-RussianDialects}, volume 1, . Nakhchivan dialect. (К. Паткановъ. Матеріалы для изученія арм. нарѣчій, I. Говоръ Нахичеванскій)
