...
\translator{This chapter is written by the translator (me). The content is based on the final pages of  Adjarian's book, where he provides  a list of placenames and a map.}
