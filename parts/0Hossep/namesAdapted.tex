...
On Wikimedia, a user had modified the 1909 map to add colorcoding to it.\footnote{\url{https://commons.wikimedia.org/wiki/File:Armenian_dialects,_Adjarian_1909.png}} It   is displayed in Figure \ref{map:Adjarian1909color}. The names are all in English; they don't however match the names that we used in our translation. 
