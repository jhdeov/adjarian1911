...
\armenian{բ}	& 	b 	& 	voiced bilabial stop	\\
		...
		\armenian{՚, յ}̵,   \armeniang{ֈ}	& 	ɦ	& 	voiced glottal fricative	\\
...
\ex Some diphthongs were written with a superscript form of the letter <\armenian{ի}>: <\armenian{ու}\textsuperscript{\armenian{յ}}, \armenian{ը}\textsuperscript{\armenian{յ}}>. I used a superscript <i>: 	<\armenian{ուⁱ}, \armenian{ըⁱ}>. 
